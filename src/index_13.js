...
slackInteractions.action('accept_sla', (payload, respond) => {
...
function slackSlashCommand(req, res, next) {
  if (req.body.command === '/tse-help') {
    ...
    } else if (req.body.command === '/sales') {
      res.send();
      web.dialog.open({
        trigger_id: req.body.trigger_id,
        token: process.env.SLACK_ACCESS_TOKEN,
        ...
        return axios.post(req.body.response_url, {
          text: `An error occurred while opening the sales dialog: ${error.message}`,
        });
